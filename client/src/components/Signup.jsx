...
function Signup() {
    ...
    const onSubmit = async (data) => {
        ...
        await axios.post('http://localhost:3000/user/signup',userInfo,{ withCredentials: true })
        .then((response)=>{
            if(response.data){
    ...
    return (
        ...
        <>
            <div className='flex bg-slate-950 h-screen items-center justify-center' >
                <form action="" className='border border-white px-6 py-2 rounded-md space-y-3 w-96' onSubmit={handleSubmit(onSubmit)} >
                    <h1 className='text-2xl text-center '>Chat <span className='text-green-500 font-semibold'>App</span> </h1>
                    <h2 className='text-xl text-white font-bold'>Signup</h2> <br />
                    {/* Full name */}
                    ...
                    <label className="input input-bordered flex items-center gap-2 bg-slate-950">
                        ...
                        <input type="password" className="grow text-white" placeholder="confirm password"
                    ...
                    <div className='flex justify-between'>
                        ...
                        <input type="submit" value="Signup" className='text-white bg-green-500 px-2 py-1 rounded cursor-pointer' />
                    </div>
                </form>
            </div>
